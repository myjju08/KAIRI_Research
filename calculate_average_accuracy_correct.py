...
def calculate_average_accuracy():
    """Calculate average accuracy across all 4 targets using correct target class results"""
    ...
    # 결과 저장
    output_file = 'deepcache_average_accuracy_correct_results.csv'
    avg_results.to_csv(output_file, index=False)
    
    print(f"\n=== Average Accuracy Results (Correct Target Classes) ===")
